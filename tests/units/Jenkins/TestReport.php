...
namespace tests\units\shiyunJK\Jenkins;
...
class TestReport extends atoum\test
{
    ...
    {
        $jenkins    = new \mock\shiyunJK\Jenkins('url');

        $reportJson = json_decode(file_get_contents(__DIR__ . '/report_passed.json'));
        $report     = new \shiyunJK\Jenkins\TestReport($jenkins, $reportJson, $jobName = 'units', $buildNumber = '32');
